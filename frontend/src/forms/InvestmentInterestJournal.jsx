  ...
  return (
    <div className="space-y-6">
      {/* Top Section: Data Entry Form */}
            <FormHeader 
        title="ලාභදායී ලේඛන සෘජු ජර්නලය" 
        subtitle="Investment Interest Journal" 
        formNumber="Schedule 07" 
      />
<div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <form onSubmit={handleAddEntry} className="p-6 space-y-8">
          ...
          <div>
            <h3 className="text-lg font-bold text-slncc-blue mb-4 border-b border-indigo-100 pb-2">Investment Details (තැන්පතු විස්තර)</h3>
