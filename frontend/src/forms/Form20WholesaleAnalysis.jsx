      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 bg-slate-50 p-5 rounded-xl border border-slate-200">
               ...
               <div>
                  ...
                  <input type="text" name="buyerName" value={formData.buyerName} onChange={handleChange} className="w-full px-4 py-2 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-slncc-blue outline-none" />
               </div>
               <div>
               ...
               <div>
                  ...
                  <input type="text" name="ledgerPage" value={formData.ledgerPage} onChange={handleChange} className="w-full px-4 py-2 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-slncc-blue outline-none" />
               </div>
            </div>
