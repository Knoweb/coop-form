...
export default function Form22StockTaking() {
  ...
  return (
    <div className="max-w-[110rem] mx-auto space-y-6">
      {/* Header Section */}
        <FormHeader 
          title="ඉතිරි බඩු ගණන් ගැනීමේ ලැයිස්තුව" 
          subtitle="Stock Taking List" 
          formNumber="Form 22" 
        />
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 bg-slate-50 p-5 rounded-xl border border-slate-200">
               <div>
                  ...
                  <input type="text" name="branchOrStore" value={formData.branchOrStore} onChange={handleChange} className="w-full px-4 py-2 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-slncc-blue outline-none" required />
               </div>
               <div>
               ...
               <div>
                  ...
                  <input type="text" name="oldLedgerRef" value={formData.oldLedgerRef} onChange={handleChange} className="w-full px-4 py-2 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-slncc-blue outline-none" />
               </div>
               <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">අලුත් පසු ග්‍රීහුම (New Ledger Ref)</label>
                  <input type="text" name="newLedgerRef" value={formData.newLedgerRef} onChange={handleChange} className="w-full px-4 py-2 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-slncc-blue outline-none" />
               </div>
               <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">ආරම්භ බිල් (Starting Bill No)</label>
                  <input type="text" name="startingBillNo" value={formData.startingBillNo} onChange={handleChange} className="w-full px-4 py-2 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-slncc-blue outline-none" />
               </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                ...
                {/* Item Details */}
                <div className="md:col-span-4 bg-slncc-gray p-4 rounded-xl border border-indigo-200">
                    ...
                    <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                <label className="block text-xs font-medium text-slncc-blue mb-1">සංකේතය (Code)</label>
                        ...
                        <div>
                            <label className="block text-xs font-medium text-slncc-blue mb-1">විස්තරය (Description)</label>
                            <input type="text" name="description" value={formData.description} onChange={handleChange} className="w-full px-3 py-1.5 bg-white border border-indigo-200 rounded-lg text-sm focus:ring-2 focus:ring-slncc-blue outline-none" />
                        </div>
                    </div>
                </div>
          ...
          <div className="mt-8 flex justify-end">
            <button type="submit" className="flex items-center space-x-2 bg-blue-600 hover:bg-opacity-90 text-white px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md font-medium">
