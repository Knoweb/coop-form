                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input type="number" step="0.01" name="totalAmount" value={formData.totalAmount} onChange={handleInputChange} placeholder="0.00"
                      className="w-full px-3 py-2 rounded-lg border border-indigo-200 bg-slncc-gray/30 focus:bg-white focus:ring-2 focus:ring-slncc-blue focus:border-slncc-blue transition-colors duration-200 text-sm font-bold text-slncc-blue" />
                  </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
          <div className="p-4 md:p-6 border-b border-slate-100 flex items-center justify-between">
             ...
             <button
                ...
                className="flex items-center space-x-1 px-3 py-1.5 bg-slncc-gray text-slncc-blue font-semibold rounded-lg hover:bg-indigo-200 transition-colors"
            ...
            <div className="overflow-x-auto w-full rounded-xl border border-slate-200">
              <table className="w-full min-w-[1000px] text-left border-collapse table-fixed">
                ...
                <tr className="bg-slate-50">
                  ...
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold bg-slncc-blue text-white uppercase break-words border border-slate-300">Store (ගබඩාව)</th>
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold bg-slncc-blue text-white uppercase break-words border border-slate-300">Bill No (බිල් අංකය)</th>
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold bg-slncc-blue text-white uppercase break-words border border-slate-300">Name (නම)</th>
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold bg-slncc-blue text-white uppercase break-words border border-slate-300">Folio (පිටුව)</th>
                  
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold text-slncc-blue uppercase break-words bg-slncc-gray border border-slate-300">Total (මුළු මුදල)</th>
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold bg-slncc-blue text-white uppercase break-words bg-slate-50/50 border border-slate-300">Goods (බඩු)</th>
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold bg-slncc-blue text-white uppercase break-words bg-slate-50/50 border border-slate-300">A.Pa.Haal (ඇ.පා.හාල්)</th>
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold bg-slncc-blue text-white uppercase break-words bg-slate-50/50 border border-slate-300">Patawum (පැටවුම්)</th>
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold bg-slncc-blue text-white uppercase break-words bg-slate-50/50 border border-slate-300">His Bhajana (හිස් භාජන)</th>
                  <th className="px-1 py-2 text-[10px] md:text-xs leading-tight font-bold bg-slncc-blue text-white uppercase break-words bg-slate-50/50 border border-slate-300">Prawahana (ප්‍රවාහන)</th>
                </tr>
              </thead>
              <tbody>
                {showManualRow && (
                ...
                {records.length === 0 && !showManualRow ? (
                  ...
                  records.map((record) => (
                    <tr key={record.id} className="hover:bg-slate-50/50 transition-colors group">
                      ...
                      <td className="px-1 py-2 text-xs leading-tight font-bold text-slncc-blue bg-slncc-gray/10 break-words border border-slate-300">{record.totalAmount?.toFixed(2) || '-'}</td>
                ...
                <tr className="bg-slate-50/80 font-bold">
                  ...
                  <td className="px-1 py-3 text-xs leading-tight text-slncc-blue break-words border border-slate-300 bg-slncc-gray">{totals.totalAmount.toFixed(2)}</td>
                ...
                <tr className="bg-slate-50/80 font-bold group">
                  <td colSpan="5" className="px-2 py-3 text-sm leading-tight text-slate-800 text-right break-words border border-slate-300 transition-colors group-hover:bg-slncc-gray/30">පෙර සටහනේ.......................</td>
                  <td className="px-1 py-1 border border-slate-300 bg-slncc-gray/30">
                    <input type="number" step="0.01" className="w-full h-full bg-white border border-slate-300 rounded focus:ring-2 focus:ring-indigo-400 text-xs px-2 py-1.5 text-slncc-blue font-bold outline-none" placeholder="0.00" value={peraSatahane.totalAmount} onChange={(e) => setPeraSatahane({...peraSatahane, totalAmount: e.target.value})} />
                  </td>
                  <td className="px-1 py-1 border border-slate-300 bg-slncc-gray/30">
                ...
                <tr className="bg-slncc-gray/60 font-extrabold text-slncc-blue border-t-2 border-indigo-300 shadow-sm">
