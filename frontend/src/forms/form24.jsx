    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-200 text-slate-800 p-4 md:p-6 font-sans pb-24">
      <div className="w-full mx-auto space-y-8 max-w-6xl">
        ...
        <header className="flex items-center space-x-3 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">Form 24 (සැපයිය යුතු බඩු ලැයිස්තුව)</h1>
            <p className="text-sm text-slate-500 font-medium mt-1">List of Goods to be Supplied</p>
          </div>
        </header>
