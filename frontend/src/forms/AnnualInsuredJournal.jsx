  ...
  return (
    <div className="space-y-6">
      {/* Top Section: Data Entry Form */}
            <FormHeader 
        title="ජාතික රක්ෂිත ජර්නලය" 
        subtitle="Annual Insured Journal" 
        formNumber="Schedule 05" 
      />
<div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <form onSubmit={handleAddEntry} className="p-6 space-y-8">
          ...
          <div>
            <h3 className="text-lg font-bold text-slncc-blue mb-4 border-b border-indigo-100 pb-2">Policy Details (පොලිසි විස්තර)</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-slncc-blue mb-4 border-b border-indigo-100 pb-2">Monthly Breakdown (මාසික විස්තර)</h3>
